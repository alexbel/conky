...
free_used_title = "$color0${voffset 5}${goto 100}Free${goto 200}Used${goto 300}Size${goto 420}Used"

partitions = []
secrets['hard_drives']['partitions'].each do |partition_name, partition|
  conky_partition = "${color0}#{partition_name}$color${goto 90}${fs_free #{partition}}${goto 190}${fs_used #{partition}}${goto 290}${fs_size #{partition}}${goto 390}${fs_bar 14,100 #{partition}}${goto 430}$color0${fs_used_perc #{partition}}%"
