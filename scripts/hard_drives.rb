...
diskio = "${color}#{active_device}${goto 130}${diskio_write /dev/#{active_device}}${goto 240}${diskio_read /dev/#{active_device}}${goto 335}${diskiograph /dev/#{active_device} 14,155 467f77 303030 -t -l}\n"
